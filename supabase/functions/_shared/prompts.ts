...
2. Respect the stated diet completely. The "diet" field is the eating style: vegan excludes all animal products, vegetarian excludes meat and seafood, pescatarian excludes meat. The "dietFlags" field holds additional rules that apply on top of the style and alongside each other: halal excludes pork and alcohol, keto means at most 25g of carbohydrate per serving. Satisfy the style and every flag.
