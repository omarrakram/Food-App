...
export const LOCAL_RECIPE_IMAGES: Record<string, LocalRecipeImage> = {
  ...
  "black-bean-quesadilla": {
    ...
    creator: "Cayobo",
    license: "CC-BY-2.0",
    attribution: "Cayobo · CC-BY-2.0 · Wikimedia Commons",
    sourcePage: "https://commons.wikimedia.org/wiki/File:Carnitas_and_Black_Bean_Quesadilla,_Key_West_Florida_2022.jpg",
  },
  "bruschetta-tomato": {
  ...
  "chicken-fried-rice": {
    ...
    sourcePage: "https://commons.wikimedia.org/wiki/File:Koh_Mak,_Thailand,_Fried_rice_with_seafood,_Thai_fried_rice.jpg",
  },
  "chicken-parm-oven": {
  ...
  "dal-tadka": {
    source: require('../../../assets/recipes/dal-tadka.png') as number,
    creator: "User:Justinc",
    license: "CC-BY-SA-2.5",
    attribution: "User:Justinc · CC-BY-SA-2.5 · Wikimedia Commons",
    sourcePage: "https://commons.wikimedia.org/wiki/File:3_types_of_lentil.png",
  },
  "egg-drop-soup": {
  ...
  "mahshi-cabbage": {
    ...
    sourcePage: "https://commons.wikimedia.org/wiki/File:02022_Hungarian_stuffed_cabbage_rolls_in_pickled_cabbage_leaves_with_veal_and_deer_meat.jpg",
  },
  "mango-sticky-rice": {
  ...
  "sesame-noodles-cold": {
    source: require('../../../assets/recipes/sesame-noodles-cold.jpg') as number,
    creator: "T.Tseng",
    license: "CC-BY-2.0",
    attribution: "T.Tseng · CC-BY-2.0 · Wikimedia Commons",
    sourcePage: "https://commons.wikimedia.org/wiki/File:Cold_Sesame_Noodles,_shredded_chicken,_pickled_cucumbers,_crispy_garlic,_crushed_peanuts,_scallions,_sesame_dressing,_chicken_broth,_yu_choy_(31967905702).jpg",
  },
  "shakshuka": {
  ...
  "shrimp-garlic": {
    source: require('../../../assets/recipes/shrimp-garlic.jpg') as number,
    creator: "T.Tseng",
    license: "CC-BY-2.0",
    attribution: "T.Tseng · CC-BY-2.0 · Wikimedia Commons",
    sourcePage: "https://commons.wikimedia.org/wiki/File:Gambas_al_Ajillo_-_Shrimp,_garlic,_white_wine_and_paprika,_Caesar%27s_Restaurante,_Tijuana.jpg",
  },
