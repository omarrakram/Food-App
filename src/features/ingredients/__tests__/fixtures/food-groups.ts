...
const OVERRIDES: Record<string, FoodGroup> = {
  ...
  'lamb-shank': 'red-meat', 'burger-patty': 'red-meat', 'beef-ribs': 'red-meat',
  'camel-meat': 'red-meat', oxtail: 'red-meat', tenderloin: 'red-meat',
  'beef-neck': 'red-meat',
  'chicken-liver': 'offal', liver: 'offal', 'duck-liver': 'offal',
  'chicken-gizzards': 'offal', trotters: 'offal', 'sausage-casing': 'offal',
  brain: 'offal', kidney: 'offal', tripe: 'offal', tongue: 'offal', spleen: 'offal',
  'marrow-bones': 'offal', 'beef-fat': 'offal',
  ...
  'chicken-drumstick': 'poultry', quail: 'poultry', 'chicken-bones': 'poultry',
  goose: 'poultry', 'chicken-hearts': 'poultry', 'chicken-feet': 'poultry',
  ...
  bottarga: 'fish', catfish: 'fish', 'nile-perch': 'fish',
  calamari: 'seafood', crab: 'seafood', mussels: 'seafood', shrimp: 'seafood',
  octopus: 'seafood', oysters: 'seafood',
  eggs: 'egg',
  ...
  'almond-flour': 'baking', 'chocolate-chips': 'baking', 'cream-caramel': 'baking',
  'cream-of-tartar': 'baking',
  'brown-sugar': 'sweetener', 'corn-syrup': 'sweetener', honey: 'sweetener',
  honeycomb: 'sweetener', 'sweetener-tablets': 'sweetener',
  sugar: 'sweetener', chocolate: 'sweetener',
  'corn-oil': 'oil', 'sesame-oil': 'oil', 'vegetable-shortening': 'oil', 'palm-oil': 'oil',
  ...
  mascarpone: 'cheese', 'blue-cheese': 'cheese',
