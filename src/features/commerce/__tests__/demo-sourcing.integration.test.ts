...
const MISSING: SourcingLine[] = [
  { ingredientSlug: 'chicken-breast', quantity: 500, unit: 'g', sourceRecipeId: 'r-alfredo' },
  { ingredientSlug: 'cream', quantity: 200, unit: 'ml', sourceRecipeId: 'r-alfredo' },
  { ingredientSlug: 'parmesan', quantity: 50, unit: 'g', sourceRecipeId: 'r-alfredo' },
];
...
describe('the shelf is not tidy, and the engine copes', () => {
  it('skips the 500ml cream because it is out of stock', () => {
    const line = sourceLine(
      { ingredientSlug: 'cream', quantity: 400, unit: 'ml', sourceRecipeId: null },
  ...
  it('never offers the delisted chicken pack', () => {
    const line = sourceLine(
      { ingredientSlug: 'chicken-breast', quantity: 500, unit: 'g', sourceRecipeId: null },
  ...
  it('never offers a mapping a human blocked', () => {
    ...
    const line = sourceLine(
      { ingredientSlug: 'butter', quantity: 100, unit: 'g', sourceRecipeId: null },
...
describe('an allergy changes the basket, not the ranking', () => {
  ...
  it('leaves a dairy-allergic cook with no parmesan at all, honestly', () => {
    ...
    const line = sourceLine(
      { ingredientSlug: 'parmesan', quantity: 50, unit: 'g', sourceRecipeId: null },
...
describe('the bigger pack wins when it actually costs less', () => {
  it('prefers 1kg of chicken over two 500g packs for a 900g recipe', () => {
    const line = sourceLine(
      { ingredientSlug: 'chicken-breast', quantity: 900, unit: 'g', sourceRecipeId: null },
      demoCandidatesFor('chicken-breast'),
      CONTEXT,
    );
...
describe('a product with no published allergen data', () => {
  it('is offered but not chosen for a cook with allergies', () => {
    ...
    const line = sourceLine(
      { ingredientSlug: 'baladi-bread', quantity: 2, unit: 'piece', sourceRecipeId: null },
