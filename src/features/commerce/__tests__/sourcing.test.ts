...
describe('sourcing a whole basket', () => {
  it('counts what the cook still has to resolve', () => {
    const lines: SourcingLine[] = [
      { ingredientSlug: 'chicken-breast', quantity: 500, unit: 'g', amount: 'measured', sourceRecipeId: 'r1', requestLineId: null },
      { ingredientSlug: 'cream', quantity: 200, unit: 'ml', amount: 'measured', sourceRecipeId: 'r1', requestLineId: null },
      { ingredientSlug: 'parmesan', quantity: 50, unit: 'g', amount: 'measured', sourceRecipeId: 'r1', requestLineId: null },
    ];
